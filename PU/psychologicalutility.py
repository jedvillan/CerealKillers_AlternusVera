...
class CerealKillers_PsychologicalUtility:
  def __init__(self):
    self.predictor_rank = task2.load('/content/drive/MyDrive/cereal-killers/finalmodels/ag_predict')
    self.predictor_sts = task.load('/content/drive/MyDrive/cereal-killers/finalmodels/saved_dir')
