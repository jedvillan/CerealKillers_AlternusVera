...
class CerealKillers_SentimentClassifier(nn.Module):
  def __init__(self):
    ...
    self.tokenizer = BertTokenizer.from_pretrained('/content/drive/MyDrive/cereal-killers/finalmodels/saved_model/')
    self.bert = BertModel.from_pretrained("/content/drive/MyDrive/cereal-killers/finalmodels/saved_model/")
